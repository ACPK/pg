...
Instead of always tying them into my big [d50b](https://github.com/50pop/db-api) database, it seemed better to keep experiments isolated with minimum context or baggage.
